# O CÓDIGO É PARA FINS DE ESTUDO E FOI ADAPTADO DE UM ARTIGO NA INTERNET
...
countries = ['Canada', 'Germany', 'United Kingdom', 'Brazil', 'France', 'China']
...
populations = {'Canada':37664517, 'Germany': 83721496 , 'United Kingdom': 67802690 , 'Brazil': 210147125, 'France': 65239883, 'China':1438027228} #Dictionary
percapita = covid.copy()
for country in list(percapita.columns):
    percapita[country] = percapita[country]/populations[country]*100000 

# Section 6 - Generating Colours and Style
colors = {'Canada':'#045275', 'China':'#089099', 'France':'#7CCBA2', 'Germany':'#FCDE9C', 'Brazil':'#DC3977', 'United Kingdom':'#7C1D6F'}
